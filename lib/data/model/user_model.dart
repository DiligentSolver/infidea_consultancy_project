  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    try {
      ...
      return UserModel(
        ...
        calculatedAge: userData['calculatedAge'] ?? 0,
        ...
        languagesKnown: List<String>.from(userData['languagesKnown'] ?? []),
        ...
        preferredRoles: List<String>.from(userData['preferredRoles'] ?? []),
...
class PreferredCity {
  ...
  PreferredCity({required this.city});
...
class Education {
  ...
  Education(
      ...
      required this.postgraduateCollege,
      required this.postgraduateUniversity,
      required this.postgraduatePassingYear,
      required this.postgraduateStartingYear,
      required this.postgraduateGrade,
      required this.postgraduateBranch,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'grade': grade,
      'branch': branch,
      'postgraduateDegree': degree,
      'postgraduateCollege': college,
      'postgraduateUniversity': university,
      'postgraduatePassingYear': passingYear,
      'postgraduateStartingYear': startingYear,
      'postgraduateGrade': grade,
      'postgraduateBranch': branch,
    };
  }
}
    ...
    try {
      return Location(
        ...
        coordinates: (json['coordinates'] as List?)
                ?.map(
                    (e) => (e as num).toDouble()) // Ensure conversion to double
                .toList() ??
            [],
      );
    } catch (e) {
